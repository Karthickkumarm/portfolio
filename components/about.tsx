...
export default function About() {
  ...
  return (
    <motion.section
      className="w-full text-center leading-8 scroll-mt-28 px-4 sm:px-8"
    ...
    >
        ...
        <p className="mb-3">
        Hey there! I'm a{" "}
        <span className="font-medium">Software Development Engineer II</span> at Rocket India, and I'm all about building things that not only work flawlessly, but also feel great to use. My journey in tech began with a{" "}
