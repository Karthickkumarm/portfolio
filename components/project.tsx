...
export default function Project({
    ...
    return(
        ...
        sm:h-[20rem] sm:group-even:pl-8 rounded-lg
        hover:bg-gray-200 transition dark:text-white dark:bg-white/10 dark:hover:bg-white/20">
            ...
            group-even:group-hover:translate-x-3 group-even:group-hover:translate-y-3 group-even:group-hover:rotate-2"src={imageUrl} alt="Project I worked on" quality={95}/>
        </motion.section>
        </motion.div>
    );
}